// src/components/venue/RatingPrompt.tsx
...
/**
 * A component that prompts users to rate a venue they've booked
 */
const RatingPrompt: React.FC<RatingPromptProps> = ({ 
  ...
  if (!hasUserBooked) {
    return (
      <div className="bg-blue-50 p-4 rounded-lg mt-6 mb-6">
        <h3 className="font-bold text-lg mb-2 font-averia">Rate this venue</h3>
        <p className="mb-3">You need to book and stay at this venue before you can rate it.</p>
